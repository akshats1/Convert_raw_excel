...
# Usage
input_file = 'output_grouped_coordinates_25_Nov_test2.xlsx'  # Replace with your file path
output_file = 'output_reversed_Final_25_Nov_test2_update.xlsx'  # Specify the output file name
