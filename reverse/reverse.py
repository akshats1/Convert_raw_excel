...
# Usage
input_file = 'output_grouped_coordinates_22_Nov_test10.xlsx'  # Replace with your file path
output_file = 'output_reversed_Final_22_Nov_t10.xlsx'  # Specify the output file name
